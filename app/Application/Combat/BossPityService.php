 ...
 * 2026-07-29): boss ma bazowo 10% szansy na wylosowanie jako przeciwnik w
 ...
 * do 0 (czyli z powrotem do 10%) w momencie, gdy boss faktycznie się pojawi
...
{
    private const BASE_CHANCE_PERCENT = 10.0;
