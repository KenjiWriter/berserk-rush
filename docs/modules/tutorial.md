...
- **Brońmistrz i Ulepszenia (game_stage 17-20)**: Kapitan zabiera gracza do Brońmistrza, objaśnia mechaniki kupna, sprzedaży oraz Kuźni Ulepszeń (+0 do +9). Na etapie 19 podświetlone zostają wszystkie bronie startowe w sklepie, dając graczowi pełny wybór pierwszej broni (np. Miecz, Topór, Łuk, Różdżka, Sztylet, Dzwon).
