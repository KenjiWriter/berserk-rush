...
- **Zbroje (Klatka, Głowa, Stopy):** Zwiększone punkty życia, obrona, szansa na unik (`dodge_chance`, 1-3%), odporność na konkretną rasę potworów, lub odporność (1-7%) na otrucie (`resist_poison`) i ogłuszenie (`resist_stun`) - redukuje szansę przeciwnika z `poison_chance`/`stun_chance` powyżej.
