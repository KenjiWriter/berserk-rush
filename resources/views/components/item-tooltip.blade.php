...
@php
    ...
    $formatStatName = function(string $statKey): string {
        $map = [
            ...
            'poison_chance' => 'Otrucie',
            'stun_chance' => 'Ogłuszenie',
            ...
            'strong_vs_magic' => 'Silny vs Magię',
            'resist_magic' => 'Odporność na Magię',
            'strong_vs_hero' => 'Silny vs Bohaterów',
            'double_exp_chance' => 'Podwójne EXP',
            'double_gold_chance' => 'Podwójne Złoto',
            'double_drop_chance' => 'Podwójny Łup',
            'bleed_chance' => 'Krwawienie',
            'double_strike_chance' => 'Podwójny Cios',
