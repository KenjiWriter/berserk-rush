        ...
        <div class="flex items-center justify-between mb-8">
            <div class="bg-black/60 border border-amber-700/50 rounded-lg p-4 shadow-2xl backdrop-blur-md">
                <h2 class="text-2xl font-bold text-amber-500 medieval-font flex items-center gap-2 tracking-wider">
                    <i class="fa-solid fa-shield-halved text-amber-500 text-2xl mr-1"></i> Zbrojmistrz
                </h2>
            </div>
                                                ...
                                                <div class="space-y-3 mb-6">
                                                    ...
                                                    @foreach($cost['materials'] as $reqMat)
                                                        ...
                                                        <div class="relative group hover:z-[100]">
                                                            ...
                                                            <!-- Tooltip -->
                                                            <div class="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-64 bg-black/95 border border-amber-900/50 rounded-lg p-3 text-sm text-gray-300 hidden group-hover:block z-[9999] shadow-2xl backdrop-blur-sm pointer-events-none">
