    ...
    <div class="relative w-full px-6 md:px-10 lg:px-12 py-8 min-h-screen flex flex-col">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
                ...
                <button wire:click="goToBlacksmith" @click="$dispatch('location-leave', { text: 'Podróż do Kowala...', icon: 'fa-solid fa-hammer', url: '{{ route('city.blacksmith', $character->id) }}' })"
                    ...
                    <i class="fa-solid fa-hammer mr-2 text-amber-300"></i> Kowal (Ulepszanie i Rzemiosło)
                </button>
