        ...
        $monstersByMap = [
            'Mroczny Las' => [
                ...
                [
                    ...
                    'level' => 3,
                    'rank' => 'regular',
                    'stats' => ['hp' => 60, 'atk' => 14, 'def' => 3, 'agi' => 5, 'int' => 3, 'crit' => 0.2, 'dodge' => 0.12],
                    'abilities' => []
                ],
                [
                    ...
                    'level' => 4,
                    'rank' => 'regular',
                    'stats' => ['hp' => 50, 'atk' => 12, 'def' => 2, 'agi' => 6, 'int' => 3, 'crit' => 0.28, 'dodge' => 0.2],
                    'abilities' => []
                ],
                [
                    'name' => 'Pająk Leśny',
                    ...
                    'level' => 5,
                    'rank' => 'regular',
                    'stats' => ['hp' => 68, 'atk' => 15, 'def' => 3, 'agi' => 6, 'int' => 3, 'crit' => 0.22, 'dodge' => 0.15],
                    'abilities' => []
                ],
                [
                    'name' => 'Suchodrzew',
                    ...
                    'level' => 6,
                    'rank' => 'regular',
                    'stats' => ['hp' => 85, 'atk' => 19, 'def' => 5, 'agi' => 2, 'int' => 3, 'crit' => 0.12, 'dodge' => 0.08],
                    'abilities' => []
                ],
                [
                    'name' => 'Zdziczały Dzik',
                    ...
                    'level' => 7,
                    'rank' => 'regular',
                    'stats' => ['hp' => 80, 'atk' => 18, 'def' => 5, 'agi' => 4, 'int' => 2, 'crit' => 0.18, 'dodge' => 0.10],
                    'abilities' => []
                ],
                [
                    ...
                    'level' => 8,
                    'rank' => 'regular',
                    'stats' => ['hp' => 75, 'atk' => 17, 'def' => 4, 'agi' => 7, 'int' => 5, 'crit' => 0.32, 'dodge' => 0.24],
                    'abilities' => []
                ],
                [
