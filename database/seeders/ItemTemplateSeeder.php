...
class ItemTemplateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $manualItems = [
            ...
            ['id' => '01k4jpx94j70x2vv10b835cst1', 'name' => 'Skrzynia Ksiąg Umiejętności', 'type' => 'consumable', 'sub_type' => 'chest', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['loot_table' => 'Skrzynia Ksiąg Umiejętności'], 'description' => 'Tajemnicza skrzynia zawierająca wiedzę o sztukach walki. Po otwarciu przyznaje losową Księgę Umiejętności.', 'icon' => 'skrzynia-ksiag-umiejetnosci.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 70, 'rare' => 30]],
