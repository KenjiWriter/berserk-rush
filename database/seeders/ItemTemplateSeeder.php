...
class ItemTemplateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $manualItems = [
            ...
            // Consumable Scrolls & Skill Progression Items
            ['id' => '01k4jpx94j70x2vv10b835cst1', 'name' => 'Skrzynia Ksiąg Umiejętności', 'type' => 'consumable', 'sub_type' => 'chest', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['loot_table' => 'chest_skrzynia-ksiag-umiejetnosci_loot'], 'description' => 'Tajemnicza skrzynia zawierająca wiedzę o sztukach walki. Po otwarciu przyznaje losową Księgę Umiejętności.', 'icon' => 'skrzynia-ksiag-umiejetnosci.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 70, 'rare' => 30]],
            
            // Specialized Skill Books per Weapon Category
            ['id' => '01k4jpx94j70x2vv10b835sbk1', 'name' => 'Księga Walki Mieczem', 'type' => 'material', 'sub_type' => 'skill_book_sword', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'sword'], 'description' => 'Starożytny księga zawierający sekrety władania mieczem. Wymagana do ulepszania umiejętności miecza (M1-M10).', 'icon' => 'ksiega-miecz.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],
            ['id' => '01k4jpx94j70x2vv10b835sbk2', 'name' => 'Księga Sztuki Topora', 'type' => 'material', 'sub_type' => 'skill_book_axe', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'axe'], 'description' => 'Starożytny księga z technikami niszczycielskich ataków toporem. Wymagana do ulepszania umiejętności toporów (M1-M10).', 'icon' => 'ksiega-topor.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],
            ['id' => '01k4jpx94j70x2vv10b835sbk3', 'name' => 'Księga Łucznictwa', 'type' => 'material', 'sub_type' => 'skill_book_bow', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'bow'], 'description' => 'Księga precyzji i dalekiego zasięgu. Wymagana do ulepszania umiejętności łuku (M1-M10).', 'icon' => 'ksiega-luk.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],
            ['id' => '01k4jpx94j70x2vv10b835sbk4', 'name' => 'Księga Tajemnic Różdżki', 'type' => 'material', 'sub_type' => 'skill_book_wand', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'wand'], 'description' => 'Księga tajemnej wiedzy magii zaklinania i żywiołów. Wymagana do ulepszania czarów różdżki (M1-M10).', 'icon' => 'ksiega-rosdzka.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],
            ['id' => '01k4jpx94j70x2vv10b835sbk5', 'name' => 'Księga Magii Dzwonu', 'type' => 'material', 'sub_type' => 'skill_book_bell', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'bell'], 'description' => 'Zapiski mistycznych rezonansów dzwonu. Wymagana do ulepszania czarów dzwonu (M1-M10).', 'icon' => 'ksiega-dzwon.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],
            ['id' => '01k4jpx94j70x2vv10b835sbk6', 'name' => 'Księga Mistrzostwa Sztyletów', 'type' => 'material', 'sub_type' => 'skill_book_dagger', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'dagger'], 'description' => 'Podręcznik cichych i zabójczych pchnięć sztyletami. Wymagana do ulepszania umiejętności sztyletów (M1-M10).', 'icon' => 'ksiega-sztylety.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],
            ['id' => '01k4jpx94j70x2vv10b835sbk7', 'name' => 'Księga Ogólnych Technik', 'type' => 'material', 'sub_type' => 'skill_book_all', 'slot' => null, 'level_requirement' => 1, 'base_stats' => ['weapon_type' => 'all'], 'description' => 'Traktat uniwersalnych zasad walki i aur pasywnych. Wymagana do ulepszania skilli uniwersalnych (M1-M10).', 'icon' => 'ksiega-ogolna.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 60, 'rare' => 40]],

            ['id' => '01k4jpx94j70x2vv10b835sst1', 'name' => 'Kamień Duchowy', 'type' => 'material', 'sub_type' => 'soul_stone', 'slot' => null, 'level_requirement' => 1, 'base_stats' => [], 'description' => 'Mistyczny kamień nasycony potężną energią duchową. Wymagany do ulepszania umiejętności na poziomach Arcymistrza (G1-G10).', 'icon' => 'kamien-duchowy.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 20, 'rare' => 80]],
            ...
            ['id' => '01k4jpx94j70x2vv10b835key1', 'name' => 'Klucz Katakumb', 'type' => 'material', 'sub_type' => 'key', 'slot' => null, 'level_requirement' => 12, 'base_stats' => [], 'description' => 'Zardzewiały klucz do Zapomnianych Katakumb.', 'icon' => 'klucz-katakumb.png', 'rarity_weights' => ['common' => 0, 'uncommon' => 70, 'rare' => 30]],
            // UWAGA (bufor startowy gracza, 2026-08-06 - feedback: postać na 1 lvl nie
            // jest w stanie nikogo ubić na 1 mapie): atrybuty 3 przedmiotów startowych
            // (Zardzewiały Miecz/Hełm, Skórzana Zbroja - dawane przez Kapitana, is_tradeable
            // = false) podniesione o ok. 70-80% względem oryginalnych wartości, żeby dać
            // świeżej postaci realny bufor DEF/HP i wyższy atk_min/max w starciu z
            // najsłabszymi potworami Mrocznego Lasu (patrz MonsterSeeder.php).
            ['id' => '01k4jpx94j70x2vv10b835prm4', 'name' => 'Zardzewiały Miecz', 'type' => 'weapon', 'sub_type' => 'sword', 'slot' => 'main_hand', 'level_requirement' => 1, 'base_stats' => ['attack_min' => $this->statRange(4), 'attack_max' => $this->statRange(7), 'crit_chance' => $this->statRange(2), 'vit_bonus' => $this->statRange(9)], 'description' => 'Podstawowa broń.', 'icon' => 'zardzewialy-miecz.png', 'rarity_weights' => ['common' => 100], 'is_tradeable' => false],
            ...
            ['id' => '01k4jpx94j70x2vv10b835hlm1', 'name' => 'Zardzewiały Hełm', 'type' => 'armor', 'sub_type' => null, 'slot' => 'head', 'level_requirement' => 1, 'base_stats' => ['defense' => $this->statRange(4), 'hp_bonus' => $this->statRange(14)], 'description' => 'Podstawowy hełm ochronny podarowany przez Kapitana.', 'icon' => 'helm-rekruta.png', 'rarity_weights' => ['common' => 100], 'is_tradeable' => false],
            ['id' => '01k4jpx94j70x2vv10b835arm1', 'name' => 'Skórzana Zbroja', 'type' => 'armor', 'sub_type' => null, 'slot' => 'chest', 'level_requirement' => 1, 'base_stats' => ['defense' => $this->statRange(7), 'hp_bonus' => $this->statRange(24)], 'description' => 'Solidna zbroja podarowana przez Kapitana na koniec wstępnego treningu.', 'icon' => 'zbroja-rekruta.png', 'rarity_weights' => ['common' => 100], 'is_tradeable' => false],
        ];
