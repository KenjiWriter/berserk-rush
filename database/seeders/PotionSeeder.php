    ...
    public function run(): void
    {
        $potions = [
            ...
            [
                ...
                'type' => 'consumable',
                'level_requirement' => 1,
                'base_stats' => ['hp_pct' => 5, 'heal_pct' => 15, 'duration_minutes' => 60],
                'description' => 'Zwiększa maksymalne punkty zdrowia o 5% na 1 godzinę. Użyta w lochu lub evencie lokacji natychmiast przywraca 15% HP.',
                'icon' => 'potion-hp.png',
                'price' => 100,
            ],
            [
                ...
                'type' => 'consumable',
                'level_requirement' => 10,
                'base_stats' => ['hp_pct' => 10, 'heal_pct' => 35, 'duration_minutes' => 180],
                'description' => 'Zwiększa maksymalne punkty zdrowia o 10% na 3 godziny. Użyta w lochu lub evencie lokacji natychmiast przywraca 35% HP.',
                'icon' => 'potion-hp.png',
                'price' => 500,
            ],
            [
                ...
                'type' => 'consumable',
                'level_requirement' => 25,
                'base_stats' => ['hp_pct' => 15, 'heal_pct' => 50, 'duration_minutes' => 360],
                'description' => 'Zwiększa maksymalne punkty zdrowia o 15% na 6 godzin. Użyta w lochu lub evencie lokacji natychmiast przywraca 50% HP.',
                'icon' => 'potion-hp.png',
                'price' => 2500,
            ],
            ...
            [
                ...
                'type' => 'consumable',
                'level_requirement' => 1,
                'base_stats' => ['mana_pct' => 5, 'mana_heal_pct' => 15, 'duration_minutes' => 60],
                'description' => 'Zwiększa maksymalną manę o 5% na 1 godzinę. Użyta w lochu lub evencie lokacji natychmiast przywraca 15% Many.',
            ...
            [
                ...
                'type' => 'consumable',
                'level_requirement' => 10,
                'base_stats' => ['mana_pct' => 10, 'mana_heal_pct' => 35, 'duration_minutes' => 180],
                'description' => 'Zwiększa maksymalną manę o 10% na 3 godziny. Użyta w lochu lub evencie lokacji natychmiast przywraca 35% Many.',
                'icon' => 'potion-mana.png',
                'price' => 500,
            ],
            [
                ...
                'type' => 'consumable',
                'level_requirement' => 25,
                'base_stats' => ['mana_pct' => 15, 'mana_heal_pct' => 50, 'duration_minutes' => 360],
                'description' => 'Zwiększa maksymalną manę o 15% na 6 godzin. Użyta w lochu lub evencie lokacji natychmiast przywraca 50% Many.',
                'icon' => 'potion-mana.png',
                'price' => 2500,
            ],
